      ...
      <div class="card">
        <div class="card-body register-card-body">
          ...
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Nama Anda" name="nama_pelanggan" value="<?php echo set_value('nama_pelanggan') ?>">
          ...
          <div class="input-group mb-3">
            ...
            name="ulangi_password" value="<?php echo set_value('ulangi_password') ?>">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-lock"></span>
              </div>
