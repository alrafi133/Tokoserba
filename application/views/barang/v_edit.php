      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="number" min="0" class="form-control" placeholder="Berat Barang..." name="berat" value="<?=$barang->berat ?>">
          </div>
        </div>
      </div>
      <div class="form-group">
        <label>Deskripsi Barang</label>
        <textarea name="deskripsi" cols="80" rows="5" class="form-control"><?=$barang->deskripsi ?></textarea>
      </div>
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <img src="<?= base_url('assets/uploads/'.$barang->gambar ) ?>" width="200" id="gambar_load">
          </div>
        </div>
      </div>
      <div class="col-sm-6">
