                ...
                <tr>
                  ...
                  <td>
                    <?php if ($value->status_bayar == 1): ?>
                      <button type="" class="btn btn-success btn-flat btn-sm" data-toggle="modal" data-target="#cek<?= $value->id_transaksi ?>">Cek Bukti bayar</button>
          ...
          <?php echo form_open('admin/kirim/'.$value->id_transaksi) ?>
            <table class="table">
              ...
              <tr>
                <th>Nomor Resi</th>
                <th>:</th>
                <th><input name="no_resi" class="form-control" required placeholder="Nomor Resi"></th>
              </tr>
            </table>
